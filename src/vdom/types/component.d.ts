...
declare class Component {
  ...
  _vnode: VNode | void; // self root node
  _staticTrees: Array<VNode> | void; // v-once cached trees
  _hasHookEvent: boolean;
  _provided: Object | void;
  ...
  // renderList
  _l: (val: any, render: Function) => Array<VNode> | void;
  // renderSlot
  _t: (name: string, fallback: Array<VNode> | void, props: Object | void) => Array<VNode> | void;
  // apply v-bind object
  _b: (data: any, tag: string, value: any, asProp: boolean, isSync?: boolean) => VNodeData;
  // apply v-on object
  _g: (data: any, value: any) => VNodeData;
  // check custom keyCode
  _k: (eventKeyCode: number, key: string, builtInAlias?: number | Array<number>, eventKeyName?: string) => boolean | void;
