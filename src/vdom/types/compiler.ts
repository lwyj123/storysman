declare type CompilerOptions = {
  ...
  // web specific
  mustUseProp?: (tag: string, type: string | void, name: string) => boolean; // check if an attribute should be bound as a property
  isPreTag?: (attr: string) => boolean | void; // check if a tag needs to preserve whitespace
...
declare type ModuleOptions = {
  ...
  preTransformNode: (el: ASTElement) => ASTElement | void;
  // transform an AST node after built-ins like v-if, v-for are processed
  transformNode: (el: ASTElement) => ASTElement | void;
...
declare type ASTIfCondition = { exp: string | void; block: ASTElement };
declare type ASTIfConditions = Array<ASTIfCondition>;

declare type ASTElementHandler = {
  value: string;
  params?: Array<any>;
  modifiers: ASTModifiers | void;
};
...
declare type ASTElement = {
  ...
  slotTarget?: string | void;
  slotScope?: string | void;
